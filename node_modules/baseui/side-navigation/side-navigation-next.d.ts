...
export declare function SideNavigation(props: SideNavigationProps): JSX.Element;
type ItemProps = {
    ariaControls?: string;
...
export declare function SideNavigationHeader({ children, overrides: { ListItem, ...overrides }, ...props }: SideNavigationHeaderProps): JSX.Element;
...
export declare function SideNavigationItem({ children, id, overrides: { ListItem, ...overrides }, ...props }: SideNavigationItemProps): JSX.Element;
...
export declare function SideNavigationSection(props: SideNavigationSectionProps): JSX.Element;
export {};
