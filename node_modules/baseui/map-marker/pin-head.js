...
var PinHead = function PinHead(_ref) {
  var _ref$size = _ref.size,
      ...
      secondaryLabel = _ref$secondaryLabel === void 0 ? '' : _ref$secondaryLabel,
  ...
  var _getOverrides3 = (0, _overrides.getOverrides)(overrides.EnhancerSlot, _styledComponents.StyledEnhancerSlot),
      _getOverrides4 = _slicedToArray(_getOverrides3, 2),
      EnhancerSlot = _getOverrides4[0],
      enhancerSlotProps = _getOverrides4[1];

  var _getOverrides5 = (0, _overrides.getOverrides)(overrides.LabelSlot, _styledComponents.StyledLabelSlot),
      _getOverrides6 = _slicedToArray(_getOverrides5, 2),
      LabelSlot = _getOverrides6[0],
      labelSlotProps = _getOverrides6[1];

  var _getOverrides7 = (0, _overrides.getOverrides)(overrides.Label, _styledComponents.StyledLabel),
      _getOverrides8 = _slicedToArray(_getOverrides7, 2),
      Label = _getOverrides8[0],
      labelProps = _getOverrides8[1];

  var _getOverrides9 = (0, _overrides.getOverrides)(overrides.SecondaryLabel, _styledComponents.StyledLabel),
      _getOverrides10 = _slicedToArray(_getOverrides9, 2),
      SecondaryLabel = _getOverrides10[0],
      secondaryLabelProps = _getOverrides10[1];

  var _getOverrides11 = (0, _overrides.getOverrides)(overrides.InnerAnchor, _styledComponents.StyledInnerXXSmallAnchor),
      _getOverrides12 = _slicedToArray(_getOverrides11, 2),
      InnerXXSmallAnchor = _getOverrides12[0],
      innerXXSmallAnchorProps = _getOverrides12[1];

  var _getOverrides13 = (0, _overrides.getOverrides)(overrides.OuterAnchor, _styledComponents.StyledOuterXXSmallAnchor),
      _getOverrides14 = _slicedToArray(_getOverrides13, 2),
      OuterXXSmallAnchor = _getOverrides14[0],
      outerXXSmallAnchorProps = _getOverrides14[1];

  var _getOverrides15 = (0, _overrides.getOverrides)(overrides.InnerAnchor, _styledComponents.StyledInnerXSmallAnchor),
      _getOverrides16 = _slicedToArray(_getOverrides15, 2),
      InnerXSmallAnchor = _getOverrides16[0],
      innerXSmallAnchorProps = _getOverrides16[1];

  var _getOverrides17 = (0, _overrides.getOverrides)(overrides.OuterAnchor, _styledComponents.StyledOuterXSmallAnchor),
      _getOverrides18 = _slicedToArray(_getOverrides17, 2),
      OuterXSmallAnchor = _getOverrides18[0],
      outerXSmallAnchorProps = _getOverrides18[1];
  ...
  var renderSecondaryLabel = (size === _constants.PINHEAD_SIZES_SHAPES.large || size === _constants.PINHEAD_SIZES_SHAPES.medium) && secondaryLabel;
