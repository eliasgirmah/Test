...
export var NEEDLE_HEIGHTS = Object.freeze((_Object$freeze = {}, _defineProperty(_Object$freeze, NEEDLE_SIZES.none, 0), _defineProperty(_Object$freeze, NEEDLE_SIZES.short, 4), _defineProperty(_Object$freeze, NEEDLE_SIZES.medium, 12), _defineProperty(_Object$freeze, NEEDLE_SIZES.tall, 20), _Object$freeze)); // Important: keep this sorted by size, as it used to determine label size when a secondary label is used.
...
export var FLOATING_ROUTE_MARKER_ANCHOR_POSITIONS = Object.freeze({
  topLeft: 'top-left',
...
export var FLOATING_ROUTE_MARKER_POINTER_TYPES = Object.freeze({
  diagonal: 'diagonal',
  horizontal: 'horizontal',
  vertical: 'vertical'
});
export var FLOATING_ROUTE_MARKER_POINTERS = Object.freeze((_Object$freeze4 = {}, _defineProperty(_Object$freeze4, FLOATING_ROUTE_MARKER_ANCHOR_POSITIONS.topLeft, {
...
export var FLOATING_ROUTE_MARKER_POINTER_TRANSFORMS = Object.freeze((_Object$freeze5 = {}, _defineProperty(_Object$freeze5, FLOATING_ROUTE_MARKER_ANCHOR_POSITIONS.topLeft, {
...
export var FLOATING_ROUTE_MARKER_POINTER_TYPE_WRAPPER_SIZES = Object.freeze((_Object$freeze6 = {}, _defineProperty(_Object$freeze6, FLOATING_ROUTE_MARKER_POINTER_TYPES.diagonal, {
  height: '24',
  width: '24',
  viewBox: '0 0 24 24'
