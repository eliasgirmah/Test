...
StyledRoot.displayName = 'StyledRoot';
export var StyledDot = styled('input', function (_ref2) {
  var _sizes, _colors;
  ...
  var $active = _ref2.$active,
      ...
      $theme = _ref2.$theme;
  var sizes = (_sizes = {}, _defineProperty(_sizes, SIZE.large, {
    height: $theme.sizing.scale300,
    width: $theme.sizing.scale300
  }), _defineProperty(_sizes, SIZE.medium, {
    ...
    marginBottom: '1px',
    marginLeft: '1px'
  }), _defineProperty(_sizes, SIZE.small, {
