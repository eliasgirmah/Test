...
export var StyledRoot = styled('div', function (props) {
  ...
  return _objectSpread(_objectSpread(_objectSpread(_objectSpread({}, $theme.typography.font300), getMinimumPageMargins($theme.grid.margins)), getMediaQueryPageMargins($theme)), {}, {
    boxSizing: 'border-box',
