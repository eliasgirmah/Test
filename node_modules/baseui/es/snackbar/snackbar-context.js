...
export default function SnackbarProvider({
  ...
  const containerRef = React.useRef(null); // @ts-ignore
  ...
  return /*#__PURE__*/React.createElement(SnackbarContext.Provider, {
    ...
    ref: containerRef
  }, snackbars[0] && /*#__PURE__*/React.createElement(SnackbarElement // @ts-ignore
  ...
  }, /*#__PURE__*/React.createElement(SnackbarElement // @ts-ignore
  , _extends({}, snackbars[0].elementProps, {
    actionOnClick: event => {
      // @ts-ignore
