  ...
  constructor(...args) {
    ...
    _defineProperty(this, "renderRatingContents", () => {
      ...
      for (let x = 1; x <= 5; x++) {
        ...
        const starRef = /*#__PURE__*/React.createRef(); // @ts-ignore
        ...
        React.createElement(Emoticon, _extends({
          ...
          onKeyDown: e => {
            ...
            if (e.keyCode === ARROW_UP || e.keyCode === ARROW_LEFT) {
              ...
              this.selectItem(prevIndex); // @ts-ignore
            ...
            if (e.keyCode === ARROW_DOWN || e.keyCode === ARROW_RIGHT) {
              ...
              this.selectItem(nextIndex); // @ts-ignore
