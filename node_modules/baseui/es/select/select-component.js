...
const isClick = event => event.type === 'click'; // @ts-ignore


const isLeftClick = event => event.button !== null && event.button !== undefined && event.button === 0; // @ts-ignore
...
class Select extends React.Component {
  ...
  constructor(props) {
    ...
    _defineProperty(this, "handleClick", event => {
      ...
      if (this.state.isFocused) {
        ...
        this.focusAfterClear = false; // @ts-ignore
    ...
    _defineProperty(this, "getOptionLabel", (locale, {
      option
    }) => option.isCreatable ? // @ts-ignore
    `${locale.select.create} “${option[this.props.labelKey]}”` : // @ts-ignore
    ...
    _defineProperty(this, "selectValue", ({
      ...
      if (this.props.multi) {
        this.setState({
          ...
          const valueArray = this.props.value; // @ts-ignore
    ...
    _defineProperty(this, "removeValue", item => {
      const valueArray = [...this.props.value];
      this.setValue( // @ts-ignore
      valueArray.filter(i => i[this.props.valueKey] !== item[this.props.valueKey]), item, STATE_CHANGE_TYPE.remove);
      this.focus();
    });
  ...
  renderValue(valueArray) {
    ...
    if (this.props.multi) {
      ...
      return /*#__PURE__*/React.createElement(Value // @ts-ignore
      , _extends({
  ...
  renderInput(listboxId) {
    ...
    const sharedProps = this.getSharedProps();
    const isOpen = this.state.isOpen; // @ts-ignore

    const selected = this.getValueArray(this.props.value) // @ts-ignore
  ...
  renderArrow() {
    ...
    return /*#__PURE__*/React.createElement(SelectArrow // @ts-ignore
    , _extends({
      size: sizes[this.props.size] || sizes[SIZE.default],
      title: 'open'
  ...
  filterOptions(excludeOptions) {
    ...
    const filterDoesNotMatchOption = this.props.ignoreCase ? // @ts-ignore
    opt => opt[this.props.labelKey].toLowerCase() !== filterValue.toLowerCase().trim() : // @ts-ignore
    opt => opt[this.props.labelKey] !== filterValue.trim();

    if (filterValue && this.props.creatable && // @ts-ignore
  ...
  render() {
    ...
    const sharedProps = this.getSharedProps(); // @ts-ignore
