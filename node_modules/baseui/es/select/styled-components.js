...
import { ellipsisText } from '../styles/util'; // @ts-ignore
...
function getControlPadding(props) {
  ...
  const paddingEndDir = $theme.direction === 'rtl' ? 'paddingLeft' : 'paddingRight'; // @ts-ignore
...
export const StyledDropdownListItem = StyledListItem; // @ts-ignore
