...
class MenuStatefulContainerInner extends React.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "state", { // @ts-expect-error todo(flow->ts): probably MenuStatefulContainer should be used instead of this.constructor
    ...
    _defineProperty(this, "handleAlphaDown", event => {
      ...
      if (this.refList[nextIndex]) {
        scrollItemIntoView(this.refList[nextIndex].current, // @ts-ignore
    ...
    _defineProperty(this, "focusMenu", event => {
      ...
      if (!this.state.isFocused && rootRef.current && // @ts-expect-error
