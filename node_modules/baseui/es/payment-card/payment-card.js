...
class PaymentCard extends React.Component {
  ...
  render() {
    ...
    React.createElement(Input, _extends({
      ...
      onChange: e => {
        const [position, value] = getCaretPosition(e.target.value, this.props.value ? String(this.props.value) : '', // @ts-ignore
        e.target.selectionStart); // @ts-expect-error todo(flow->ts): looks dangerous
