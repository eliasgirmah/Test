...
class BaseInput extends React.Component {
  ...
  renderMaskToggle() {
    ...
    const [MaskToggleButton, maskToggleButtonProps] = getOverrides( // @ts-ignore
    this.props.overrides.MaskToggleButton, StyledMaskToggleButton);
    const [MaskToggleShowIcon, maskToggleIconShowProps] = getOverrides( // @ts-ignore
    this.props.overrides.MaskToggleShowIcon, Show);
    const [MaskToggleHideIcon, maskToggleIconHideProps] = getOverrides( // @ts-ignore
    this.props.overrides.MaskToggleHideIcon, Hide);
    const label = this.state.isMasked ? 'Show password text' : 'Hide password text';
    const iconSize = {
      [SIZE.mini]: '12px',
      [SIZE.compact]: '16px',
      [SIZE.default]: '20px',
      [SIZE.large]: '24px' // @ts-ignore
  ...
  renderClear() {
    ...
    return /*#__PURE__*/React.createElement(ClearIconContainer, _extends({
      ...
      onClick: this.onClearIconClick // @ts-ignore
      ,
      onKeyDown: event => {
