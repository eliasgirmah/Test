...
class TimePicker extends React.Component {
  ...
  constructor(props) {
    ...
    _defineProperty(this, "secondsToLabel", (seconds, format) => {
      let [hours, minutes] = this.dateHelpers.secondsToHourMinute(seconds); // @ts-ignore
        ...
        default:
          {
            ...
            if (!meridiem) {
              ...
              const twentyFourHours = meridiem.toLowerCase()[0] === 'a' ? twelveHours : twelveHours + 12; // @ts-ignore
