...
import { LocationPuckContainer, StyledConsumerLocationPuckCore, StyledLocationPuckApproximation, StyledEarnerLocationPuckCore } from './styled-components'; // @ts-ignore
...
const EarnerLocationPuck = ({
  ...
  const [, theme] = useStyletron();
  const color = theme.colors.contentPrimary; // @ts-ignore

  const [Root, rootProps] = getOverrides(overrides.Root, LocationPuckContainer);
  const [LocationPuckApproximation, locationPuckApproximationProps] = getOverrides( // @ts-ignore
  overrides.LocationPuckApproximation, StyledLocationPuckApproximation);
  const [EarnerLocationPuckCore, earnerLocationPuckCoreProps] = getOverrides( // @ts-ignore
  overrides.EarnerLocationPuckCore, StyledEarnerLocationPuckCore);
  return /*#__PURE__*/React.createElement(Root, rootProps, /*#__PURE__*/React.createElement(LocationPuckApproximation, _extends({
    $color: color,
    $radius: confidenceRadius
