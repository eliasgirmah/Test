...
var FORMAT_STRING = "".concat(DATE_FORMAT, " ").concat(TIME_FORMAT); // @ts-ignore
...
var QUARTERS = [0, 1, 2, 3]; // @ts-ignore
...
function DatetimeFilter(props) {
      ...
      if (isCategorical) {
        ...
        if (_op === _constants.DATETIME_OPERATIONS.WEEKDAY) {
          ...
          _description = weekdays.map(function (w) {
            var day = (0, _utils.addDays)(startOfWeek, localizedWeekdays.indexOf(w));
          ...
          _description = months.map(function (m) {
            return (0, _utils.getMonthInLocale)(m, props.locale);
          }).join(', ');
          ...
          _description = quarters.map(function (q) {
            return (0, _utils.getQuarterInLocale)(q, props.locale);
          }).join(', ');
  ...
  , {
    ...
    onChange: function onChange(_ref2) {
      ...
      if (Array.isArray(date)) {
        ...
        var nextDates = date.map(function (d, i) {
          return d ? (0, _utils.applyDateToTime)(rangeDates[i], d) : null;
        });
    ...
    onChange: function onChange(time) {
      return time && setRangeDates([(0, _utils.applyTimeToDate)(rangeDates[0], time), rangeDates[1]]);
    },
    creatable: true,
    size: "compact"
  })), /*#__PURE__*/React.createElement("div", {
    ...
    value: rangeDates[1],
    onChange: function onChange(time) {
      return time && setRangeDates([rangeDates[0], (0, _utils.applyTimeToDate)(rangeDates[1], time)]);
    },
    creatable: true,
    size: "compact"
