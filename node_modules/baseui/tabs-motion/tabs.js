...
function Tabs(_ref2) {
  ...
  var _getOverrides11 = (0, _overrides.getOverrides)(overrides.TabBar, _styledComponents.StyledTabBar),
      _getOverrides12 = _slicedToArray(_getOverrides11, 2),
      TabBar = _getOverrides12[0],
      tabBarProps = _getOverrides12[1]; // Count key updates
  ...
  React.useEffect(function () {
    ...
    if (activeTabRef.current) {
      if ((0, _utils.isHorizontal)(orientation) ? // @ts-expect-error todo(flow->ts) maybe parentElement?
...
function InternalTab(_ref3) {
  ...
  var _getOverrides13 = (0, _overrides.getOverrides)(TabOverrides, _styledComponents.StyledTab),
      _getOverrides14 = _slicedToArray(_getOverrides13, 2),
      Tab = _getOverrides14[0],
      TabProps = _getOverrides14[1];

  var _getOverrides15 = (0, _overrides.getOverrides)(ArtworkContainerOverrides, _styledComponents.StyledArtworkContainer),
      _getOverrides16 = _slicedToArray(_getOverrides15, 2),
      ArtworkContainer = _getOverrides16[0],
      ArtworkContainerProps = _getOverrides16[1]; // Keyboard focus styling
...
function InternalTabPanel(_ref4) {
  ...
  var _getOverrides17 = (0, _overrides.getOverrides)(TabPanelOverrides, _styledComponents.StyledTabPanel),
      _getOverrides18 = _slicedToArray(_getOverrides17, 2),
      TabPanel = _getOverrides18[0],
      TabPanelProps = _getOverrides18[1];
