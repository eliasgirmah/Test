...
var orangeColorStates = (_orangeColorStates = {}, _defineProperty(_orangeColorStates, COLOR_STATE.disabled, function (theme, color) {
  return {
    color: pick(theme, _tokens.colors.orange200, _tokens.colors.orange600),
    // @ts-ignore
    backgroundColor: null,
    borderColor: pick(theme, _tokens.colors.orange200, _tokens.colors.orange700)
  };
}), _defineProperty(_orangeColorStates, COLOR_STATE.solid, function (theme, color) {
  return {
    color: _tokens.colors.white,
    backgroundColor: pick(theme, _tokens.colors.orange400, _tokens.colors.orange500),
    // @ts-ignore
    borderColor: null
  };
}), _defineProperty(_orangeColorStates, COLOR_STATE.outline, function (theme, color) {
  return {
    color: pick(theme, _tokens.colors.orange400, _tokens.colors.orange300),
    // @ts-ignore
    backgroundColor: null,
    borderColor: pick(theme, _tokens.colors.orange200, _tokens.colors.orange500)
  };
}), _orangeColorStates);
var purpleColorStates = (_purpleColorStates = {}, _defineProperty(_purpleColorStates, COLOR_STATE.disabled, function (theme, color) {
  return {
    color: pick(theme, _tokens.colors.purple200, _tokens.colors.purple600),
    // @ts-ignore
    backgroundColor: null,
    borderColor: pick(theme, _tokens.colors.purple200, _tokens.colors.purple700)
  };
}), _defineProperty(_purpleColorStates, COLOR_STATE.solid, function (theme, color) {
  return {
    color: _tokens.colors.white,
    backgroundColor: pick(theme, _tokens.colors.purple400, _tokens.colors.purple500),
    // @ts-ignore
    borderColor: null
  };
}), _defineProperty(_purpleColorStates, COLOR_STATE.outline, function (theme, color) {
  return {
    color: pick(theme, _tokens.colors.purple400, _tokens.colors.purple300),
    // @ts-ignore
    backgroundColor: null,
    borderColor: pick(theme, _tokens.colors.purple200, _tokens.colors.purple500)
  };
}), _purpleColorStates);
var brownColorStates = (_brownColorStates = {}, _defineProperty(_brownColorStates, COLOR_STATE.disabled, function (theme, color) {
  return {
    color: pick(theme, _tokens.colors.brown200, _tokens.colors.brown600),
    // @ts-ignore
    backgroundColor: null,
    borderColor: pick(theme, _tokens.colors.brown200, _tokens.colors.brown700)
  };
}), _defineProperty(_brownColorStates, COLOR_STATE.solid, function (theme, color) {
  return {
    color: _tokens.colors.white,
    backgroundColor: pick(theme, _tokens.colors.brown400, _tokens.colors.brown500),
    // @ts-ignore
    borderColor: null
  };
}), _defineProperty(_brownColorStates, COLOR_STATE.outline, function (theme, color) {
  return {
    color: pick(theme, _tokens.colors.brown400, _tokens.colors.brown300),
    // @ts-ignore
    backgroundColor: null,
    borderColor: pick(theme, _tokens.colors.brown200, _tokens.colors.brown500)
  };
}), _brownColorStates);
...
var colorMap = (_colorMap = {}, _defineProperty(_colorMap, _constants.KIND.neutral, neutralColorStates), _defineProperty(_colorMap, _constants.KIND.primary, primaryColorStates), _defineProperty(_colorMap, _constants.KIND.accent, accentColorStates), _defineProperty(_colorMap, _constants.KIND.positive, positiveColorStates), _defineProperty(_colorMap, _constants.KIND.warning, warningColorStates), _defineProperty(_colorMap, _constants.KIND.negative, negativeColorStates), _defineProperty(_colorMap, _constants.KIND.black, primaryColorStates), _defineProperty(_colorMap, _constants.KIND.blue, accentColorStates), _defineProperty(_colorMap, _constants.KIND.green, positiveColorStates), _defineProperty(_colorMap, _constants.KIND.red, negativeColorStates), _defineProperty(_colorMap, _constants.KIND.yellow, warningColorStates), _defineProperty(_colorMap, _constants.KIND.orange, orangeColorStates), _defineProperty(_colorMap, _constants.KIND.purple, purpleColorStates), _defineProperty(_colorMap, _constants.KIND.brown, brownColorStates), _defineProperty(_colorMap, _constants.KIND.custom, customColorStates), _colorMap); // @ts-ignore
...
var Action = (0, _styles.styled)('span', function (props) {
...
var Root = (0, _styles.styled)('span', function (props) {
  ...
  var borderWidth = !$disabled && $variant === _constants.VARIANT.solid ? 0 : '2px'; // @ts-ignore
