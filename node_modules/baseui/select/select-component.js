...
var Select = /*#__PURE__*/function (_React$Component) {
  ...
  function Select(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleClick", function (event) {
      ...
      if (_this.state.isFocused) {
        ...
        _this.focusAfterClear = false; // @ts-ignore
    ...
    _defineProperty(_assertThisInitialized(_this), "getOptionLabel", function (locale, _ref) {
      ...
      return option.isCreatable ? // @ts-ignore
      "".concat(locale.select.create, " \u201C").concat(option[_this.props.labelKey], "\u201D") : // @ts-ignore
    ...
    _defineProperty(_assertThisInitialized(_this), "selectValue", function (_ref3) {
      ...
      if (_this.props.multi) {
        _this.setState({
          ...
          var valueArray = _this.props.value; // @ts-ignore
  ...
  _createClass(Select, [{
    ...
    value: function renderInput(listboxId) {
      ...
      var sharedProps = this.getSharedProps();
      var isOpen = this.state.isOpen; // @ts-ignore

      var selected = this.getValueArray(this.props.value) // @ts-ignore
      .map(function (v) {
    ...
    value: function filterOptions(excludeOptions) {
      ...
      var filterDoesNotMatchOption = this.props.ignoreCase ? // @ts-ignore
      function (opt) {
    ...
    value: function render() {
      ...
      var sharedProps = this.getSharedProps(); // @ts-ignore
