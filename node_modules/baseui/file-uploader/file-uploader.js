...
function FileUploader(props) {
  ...
  var _getOverrides13 = (0, _overrides.getOverrides)(overrides.ButtonComponent, _button.Button),
      _getOverrides14 = _slicedToArray(_getOverrides13, 2),
      ButtonComponent = _getOverrides14[0],
      buttonProps = _getOverrides14[1];

  var _getOverrides15 = (0, _overrides.getOverrides)(overrides.RetryButtonComponent, _button.Button),
      _getOverrides16 = _slicedToArray(_getOverrides15, 2),
      RetryButtonComponent = _getOverrides16[0],
      retryButtonProps = _getOverrides16[1];

  var _getOverrides17 = (0, _overrides.getOverrides)(overrides.CancelButtonComponent, _button.Button),
      _getOverrides18 = _slicedToArray(_getOverrides17, 2),
      CancelButtonComponent = _getOverrides18[0],
      cancelButtonProps = _getOverrides18[1];

  var _getOverrides19 = (0, _overrides.getOverrides)(overrides.Spinner, _spinner.Spinner),
      _getOverrides20 = _slicedToArray(_getOverrides19, 2),
      SpinnerComponent = _getOverrides20[0],
      spinnerProps = _getOverrides20[1];

  var _getOverrides21 = (0, _overrides.getOverrides)(overrides.ProgressBar, _progressBar.ProgressBar),
