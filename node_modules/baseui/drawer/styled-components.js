...
function getSizeStyles($size, $anchor) {
  ...
  if ($anchor === _constants.ANCHOR.left || $anchor === _constants.ANCHOR.right) {
    ...
    styles.height = _constants.SIZE_DIMENSION.full; // @ts-ignore
    ...
    styles.width = _constants.SIZE_DIMENSION.full; // @ts-ignore
...
StyledRoot.displayName = 'StyledRoot';
var StyledBackdrop = (0, _styles.styled)('div', function (props) {
...
StyledBackdrop.displayName = 'StyledBackdrop'; // @ts-ignore

var StyledDrawerContainer = (0, _styles.styled)('div', function (props) {
  var $animating = props.$animating,
      $isOpen = props.$isOpen,
      $isVisible = props.$isVisible,
      $theme = props.$theme;
...
StyledDrawerContainer.displayName = 'StyledDrawerContainer';
var StyledDrawerBody = (0, _styles.styled)('div', function (props) {
...
StyledDrawerBody.displayName = 'StyledDrawerBody';
var StyledClose = (0, _styles.styled)('button', function (props) {
  var _ref;
